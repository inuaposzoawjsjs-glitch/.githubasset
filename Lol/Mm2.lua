...
Tabs.AutoFarm:AddParagraph({
        Title = "AutoFarm",
        Content = "Sorry, I didn't have time to finish it :)"
    })
...
do
    ...
    local function ToggleWalls(state)
        if state then
            ...
            for _, v in pairs(WallData.StoredWalls) do
    ...
    Tabs.Misc:AddToggle("InvisibleWalls", {
        Title = "Delete Invisible Walls",
        Default = false,
        Callback = function(Value)
            WallData.Enabled = Value
            ToggleWalls(Value)
        end
    })
...
Tabs.Misc:AddToggle("SafePlatform", {
    Title = "Anti-Void",
    Description = "",
    Default = false,
    Callback = function(Value)
        _G.VoidPlatformActive = Value
        ...
        if Value then
            ...
            task.spawn(function()
                ...
                while _G.VoidPlatformActive do
                    local char = player.Character
...
local FakeSection = Tabs.Premium:AddSection("Visuals Effects")
...
local SpectateDropdown = Tabs.Premium:AddDropdown("CrosshairTexture", {
...
Tabs.Premium:AddSection("Crosshair Size")

local CrosshairSizeEnabled = false
local CrosshairBaseSize = 30
local CrosshairObject = nil

Tabs.Premium:AddToggle("EnableCrosshairSize", {
...
Tabs.Premium:AddSlider("CrosshairSize", {
...
Tabs.Premium:AddSection("Crosshair Pulse")

local pulseEnabled = false
local pulseSpeed = 2

Tabs.Premium:AddToggle("PulseCrosshair", {
...
Tabs.Premium:AddSlider("PulseSpeed", {
    Title = "Pulse Speed",
    Default = 2,
    Min = 1,
    Max = 30,
...
Tabs.Premium:AddSection("Crosshair Spin")
...
Tabs.Premium:AddToggle("RotateCrosshair", {
...
Tabs.Premium:AddSlider("RotationSpeed", {
...
Tabs.Premium:AddSection("Crosshair RGB")
...
Tabs.Premium:AddToggle("RGBCrosshair", {
    Title = "RGB Crosshair",
    Default = false,
    Callback = function(Value)
        if Value then
...
Tabs.Premium:AddSlider("RGBSpeed", {
    Title = "RGB Speed",
    Description = "",
    Default = 1,
    Min = 0.1,
...
Tabs.Premium:AddSlider("RGBSaturation", {
...
Tabs.Premium:AddSection("Gun")

local CollectionService = game:GetService("CollectionService")

Tabs.Premium:AddToggle("DualWieldToggle", {
...
Tabs.Premium:AddSection("AvatarChanger")
...
Tabs.Premium:AddToggle("DeleteHats", {
...
Tabs.Extension:AddInput("FOV_Val", {
    Title = "FOV", 
    Default = "70", 
    Callback = function(v) 
...
Tabs.Extension:AddInput("Res_Val", {
    Title = "Stretch Res",
    Default = "1",
    Callback = function(v)
        local num = tonumber(v)
        if num then
            getgenv().Resolution[".gg/scripters"] = num
        end
    end
})

Tabs.Extension:AddInput("MaxZoomInput", {
...
Tabs.Extension:AddToggle("NoclipCam", {
    Title = "Noclip Camera",
    Description = "",
    Default = false,
    Callback = function(state)
