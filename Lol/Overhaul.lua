local Fluent = loadstring(game:HttpGet("https://raw.githubusercontent.com/inuaposzoawjsjs-glitch/.githubasset/refs/heads/master/.github/Managers/main.lua"))()
local SaveManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/inuaposzoawjsjs-glitch/.githubasset/refs/heads/master/.github/Managers/SaveManager.lua"))()
local FBM = loadstring(game:HttpGet("https://raw.githubusercontent.com/inuaposzoawjsjs-glitch/.githubasset/refs/heads/master/.github/Managers/FloatingButton.Lua"))()
local InterfaceManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/inuaposzoawjsjs-glitch/.githubasset/refs/heads/master/.github/Managers/InterfaceManager.lua"))()
...
local function mobilefly()
    ...
    bg.Parent = root
    bg.MaxTorque = Vector3.new(9e9, 0, 9e9) -- Блокируем наклон X и Z, но разрешаем игре самой крутить Y (влево/вправо)
    bg.P = 1000
    bg.D = 50
    ...
    mfly2 = RS.PreRender:Connect(function()
        ...
        if r and VelocityHandler and GyroHandler then
            ...
            -- Выравниваем гироскоп по горизонту камеры, не трогая поворот лица персонажа
